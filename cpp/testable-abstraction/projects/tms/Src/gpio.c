...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, NUCLEO_RED_LED_Pin|NUCLEO_BLUE_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : NUCLEO_RED_LED_Pin NUCLEO_BLUE_LED_Pin */
  GPIO_InitStruct.Pin = NUCLEO_RED_LED_Pin|NUCLEO_BLUE_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
